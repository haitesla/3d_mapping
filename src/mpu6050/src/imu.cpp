...
int main(int argc, char** argv)
{
  ...
  private_node_handle.param<std::string>("tf_parent_frame_id", tf_parent_frame_id, "camera_init");
  private_node_handle.param<std::string>("tf_frame_id", tf_frame_id, "microstrain");
  private_node_handle.param<std::string>("frame_id", frame_id, "microstrain");
  ...
  ros::Publisher imu_pub = nh.advertise<sensor_msgs::Imu>("/microstrain/imu", 50);
